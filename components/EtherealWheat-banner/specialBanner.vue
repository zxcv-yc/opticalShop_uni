		 ...
		 :next-margin="swiperConfig.nextMargin" @change="swiperChange" @animationfinish="animationfinish">
			<swiper-item v-for="(item, i) in bannerList" :key="i">
              ...
              transitionTimingFunction: 'ease'
					...
					<view class="pos_ab jus-spB-col">
						<view class="jus-spB-col" style="height: 100%;">
							<view class="u-font-32 text-fff u-p-t-60 u-p-l-60 u-text-left " style="width: 100%;">
								{{item.memberName}}
							</view>
							<view class="jus-center" style="width: 100%;">
								<image :src="item.qrimg" mode="aspectFill" style="width: 200upx;height: 200upx;"></image>
							</view>
							<view class="u-font-20 text-fff u-p-30 u-text-center" style="width: 100%;">
								使用微信扫一扫二维码 即刻成为会员
							</view>
						</view>
					</view>
